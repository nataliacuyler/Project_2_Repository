...
our.murders1 <- na.omit(our.murders)
our.murders1

murders.by.state <- data.frame(our.states1, our.murders1)

ggplot(murders.by.state, aes(x=our.states1, y=our.murders1, fill=our.murders1)) +
